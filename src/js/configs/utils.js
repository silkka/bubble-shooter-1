;(function(exports) {
    ...
    {
        var textPlay = BubbleShoot.game.add.bitmapText(0, 0, 'font', data.label, data.fontSize || 30);
        textPlay.anchor.setTo(0.5);
        textPlay.alpha = data.alpha || 0.7;

        var rect = BubbleShoot.game.add.sprite(
            data.position.x, data.position.y,
            Utils.createRect(textPlay.width + 25, textPlay.height + 18, data.background || '#444')
        );
        ...
        if (data.callback) {
            ...
            rect.events.onInputDown.add(data.callback, data.context);
        }
        return rect;
    }
